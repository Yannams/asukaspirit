...
export default function Footer() {
  return (
    <footer className="relative z-30 py-16 px-4 md:px-8 select-none bg-[#121212] border-t border-neutral-900">
      {/* Footer content card */}
      <div className="relative z-30 bg-white text-black rounded-[40px] p-8 md:p-12 max-w-[1171px] mx-auto w-full flex flex-col lg:flex-row justify-between items-stretch gap-12 border border-neutral-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
        ...
        <div className="flex flex-col justify-between items-stretch lg:items-end gap-10 lg:w-[50%]">
          ...
          <div className="flex items-center gap-3 lg:justify-end">
            <a href="https://www.facebook.com/asukaspiritafrique" target="_blank" rel="noopener noreferrer" className="w-[32px] h-[32px] rounded-full bg-black hover:opacity-80 flex items-center justify-center text-white transition-opacity">
              <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/asworldtech/" target="_blank" rel="noopener noreferrer" className="w-[32px] h-[32px] rounded-full bg-black hover:opacity-80 flex items-center justify-center text-white transition-opacity">
              <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/company/as-world-tech/" target="_blank" rel="noopener noreferrer" className="w-[32px] h-[32px] rounded-full bg-black hover:opacity-80 flex items-center justify-center text-white transition-opacity">
              <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
              </svg>
            </a>
            <a href="https://www.youtube.com/@asworldtech7517" target="_blank" rel="noopener noreferrer" className="w-[32px] h-[32px] rounded-full bg-black hover:opacity-80 flex items-center justify-center text-white transition-opacity">
              <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
